  ...
  return (
    <div className="text-center">
      ...
      <div className="grid grid-cols-3 max-w-7xl mx-auto pt-5 max-md:grid-cols-1 max-md:justify-items-center">
        ...
        <SinglePricingElement planName="Standard" price="1500" features={pricingFeatures.standard} />
        <SinglePricingElement planName="Professional" price="4500" features={pricingFeatures.professional} />
      </div>
    </div>
  );
};
